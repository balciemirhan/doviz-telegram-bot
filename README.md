...
- **Günlük Değişim Yüzdesi:** Her varlığın fiyatının yanında, o günkü artış veya azalış yüzdesini `(📈 +0.75%)` veya `(📉 -0.25%)` şeklinde gösterir.
- **Geniş Varlık Yelpazesi:** Döviz kurlarının yanı sıra, en çok takip edilen altın çeşitleri ve gümüş fiyatlarını içerir.
- **Doğal Dil Anlama (Temel Seviye):** "dolar kaç para?" veya "çeyrek altın ne kadar?" gibi basit cümleleri anlar ve doğrudan cevap verir.
- **İnteraktif Menüler:**
    - **Kalıcı Klavye:** Sohbet ekranının altında her zaman duran ana menü butonları.
    - **Mesaj İçi Butonlar:** Alt menüler ve geri butonları ile kolay ve sezgisel bir gezinme deneyimi.
...
#### 1. Nöbetçi Asker: Flask 💂
- **Neden?** Render'ın "Web Service" planını kandırmak için.
- **Nasıl?** Kodun içine, dışarıdan bir istek geldiğinde sadece "Bot çalışıyor..." diyen çok basit bir Flask web sunucusu ekledik.

#### 2. Uyku Engelleyici: UptimeRobot ⏰
- **Neden?** Render'ın servislerini "uyku moduna" almasını engellemek için.
- **Nasıl?** UptimeRobot, her 5 dakikada bir bizim Flask "nöbetçimizin" adresine bir istek göndererek botu sürekli uyanık tutar.

#### 3. Orkestra Şefi: Threading 🎻
- **Neden?** Hem Flask sunucusunun hem de Telegram botunun aynı anda çalışabilmesi için.
- **Nasıl?** Ana program (Müdür), en önemli iş olan Telegram botunu yönetirken; web sunucusunu arka planda çalışan bir "garsona" devreder.
